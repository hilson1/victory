...
if (isset($_POST['add'])) {
    ...
    $sql = "INSERT INTO products (name, image, description, location, price) 
...
if (isset($_POST['update'])) {
    ...
    $sql = "UPDATE products SET name='$name', description='$description', location='$location', price='$price' $image_query WHERE id=$id";
    mysqli_query($conn, $sql);
    header("Location: house.php");
}
?>
...
<head>
    ...
    <title>house Panel</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/js/bootstrap.bundle.min.js"></script>
</head>
<body class="container mt-4">

<h2 class="text-center mb-4">HOUSE</h2>
...
<table class="table table-bordered table-striped mt-4">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <a href="house.php?edit=<?= $row['id'] ?>" class="btn btn-warning btn-sm">Edit</a>
                <a href="house.php?delete=<?= $row['id'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure?')">Delete</a>
            </td>
        </tr>
        <?php endwhile; ?>
    </tbody>
